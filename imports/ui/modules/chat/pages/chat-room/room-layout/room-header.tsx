...
const RoomHeader: React.FC<RoomHeaderProps> = ({ onBackClick }) => {
  return (
      ...
      <div className="flex items-center justify-between px-3 py-3 sm:px-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h1 className="text-base sm:text-lg font-bold text-gray-900 truncate">Group Chat</h1>
            <p className="text-xs sm:text-sm text-gray-500 truncate">Click to view participants</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            ...
            <DropdownItem className="text-danger-600 hover:bg-danger-50">Report</DropdownItem>
          </Dropdown>
        </div>
      </div>
    </header>
