module.export({$TRACK:()=>$TRACK,DEV:()=>DEV,Dynamic:()=>Dynamic,For:()=>For,Index:()=>Index,Match:()=>Match,Portal:()=>Portal,Show:()=>Show,Switch:()=>Switch,addEventListener:()=>addEventListener,batch:()=>batch,className:()=>className,clearDelegatedEvents:()=>clearDelegatedEvents,convertRemToPixels:()=>convertRemToPixels,createComponent:()=>createComponent,createComputed:()=>createComputed,createContext:()=>createContext,createEffect:()=>createEffect,createMemo:()=>createMemo,createRenderEffect:()=>createRenderEffect,createRoot:()=>createRoot,createSignal:()=>createSignal,createUniqueId:()=>createUniqueId,delegateEvents:()=>delegateEvents,deleteNestedDataByPath:()=>deleteNestedDataByPath,displayValue:()=>displayValue,getMutationStatusColor:()=>getMutationStatusColor,getOwner:()=>getOwner,getPreferredColorScheme:()=>getPreferredColorScheme,getQueryStatusColor:()=>getQueryStatusColor,getQueryStatusColorByLabel:()=>getQueryStatusColorByLabel,getQueryStatusLabel:()=>getQueryStatusLabel,getSidedProp:()=>getSidedProp,insert:()=>insert,isServer:()=>isServer,lazy:()=>lazy,memo:()=>memo,mergeProps:()=>mergeProps,mutationSortFns:()=>mutationSortFns,on:()=>on,onCleanup:()=>onCleanup,onMount:()=>onMount,render:()=>render,serialize:()=>serialize,setAttribute:()=>setAttribute,setupStyleSheet:()=>setupStyleSheet,sortFns:()=>sortFns,splitProps:()=>splitProps,spread:()=>spread,stringify:()=>stringify,template:()=>template,untrack:()=>untrack,updateNestedDataByPath:()=>updateNestedDataByPath,use:()=>use,useContext:()=>useContext,useTransition:()=>useTransition});// ../../node_modules/.pnpm/solid-js@1.9.7/node_modules/solid-js/dist/solid.js
var sharedConfig = {
  context: void 0,
  registry: void 0,
  effects: void 0,
