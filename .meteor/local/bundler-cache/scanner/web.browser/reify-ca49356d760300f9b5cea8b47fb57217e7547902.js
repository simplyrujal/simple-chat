module.export({defaultShouldDehydrateMutation:()=>defaultShouldDehydrateMutation,defaultShouldDehydrateQuery:()=>defaultShouldDehydrateQuery,dehydrate:()=>dehydrate,hydrate:()=>hydrate});module.link("./chunk-PXG64RU4.js");let tryResolveSync;module.link("./thenable.js",{tryResolveSync(v){tryResolveSync=v}},0);let noop;module.link("./utils.js",{noop(v){noop=v}},1);
