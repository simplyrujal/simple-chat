module.export({QueriesObserver:()=>QueriesObserver});let __privateAdd,__privateGet,__privateMethod,__privateSet;module.link("./chunk-PXG64RU4.js",{__privateAdd(v){__privateAdd=v},__privateGet(v){__privateGet=v},__privateMethod(v){__privateMethod=v},__privateSet(v){__privateSet=v}},0);let notifyManager;module.link("./notifyManager.js",{notifyManager(v){notifyManager=v}},1);let QueryObserver;module.link("./queryObserver.js",{QueryObserver(v){QueryObserver=v}},2);let Subscribable;module.link("./subscribable.js",{Subscribable(v){Subscribable=v}},3);let replaceEqualDeep,shallowEqualObjects;module.link("./utils.js",{replaceEqualDeep(v){replaceEqualDeep=v},shallowEqualObjects(v){shallowEqualObjects=v}},4);
