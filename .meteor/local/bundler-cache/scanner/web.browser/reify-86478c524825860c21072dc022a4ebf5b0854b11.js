module.export({Views:()=>Views,WeekStart:()=>WeekStart,addDays:()=>addDays,addMonths:()=>addMonths,addYears:()=>addYears,getFirstDateInRange:()=>getFirstDateInRange,getFirstDayOfTheMonth:()=>getFirstDayOfTheMonth,getFormattedDate:()=>getFormattedDate,getWeekDays:()=>getWeekDays,isDateEqual:()=>isDateEqual,isDateInDecade:()=>isDateInDecade,isDateInRange:()=>isDateInRange,isDateRangeInDecade:()=>isDateRangeInDecade,isDateToday:()=>isDateToday,isMonthEqual:()=>isMonthEqual,startOfYearPeriod:()=>startOfYearPeriod});var Views = /* @__PURE__ */ ((Views2) => {
