module.export({hasNextPage:()=>hasNextPage,hasPreviousPage:()=>hasPreviousPage,infiniteQueryBehavior:()=>infiniteQueryBehavior});module.link("./chunk-PXG64RU4.js");let addConsumeAwareSignal,addToEnd,addToStart,ensureQueryFn;module.link("./utils.js",{addConsumeAwareSignal(v){addConsumeAwareSignal=v},addToEnd(v){addToEnd=v},addToStart(v){addToStart=v},ensureQueryFn(v){ensureQueryFn=v}},0);
