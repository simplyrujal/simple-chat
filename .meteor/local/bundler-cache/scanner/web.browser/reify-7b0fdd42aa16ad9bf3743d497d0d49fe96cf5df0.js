module.export({Query:()=>Query,fetchState:()=>fetchState});let __privateAdd,__privateGet,__privateMethod,__privateSet;module.link("./chunk-PXG64RU4.js",{__privateAdd(v){__privateAdd=v},__privateGet(v){__privateGet=v},__privateMethod(v){__privateMethod=v},__privateSet(v){__privateSet=v}},0);let ensureQueryFn,noop,replaceData,resolveEnabled,resolveStaleTime,skipToken,timeUntilStale;module.link("./utils.js",{ensureQueryFn(v){ensureQueryFn=v},noop(v){noop=v},replaceData(v){replaceData=v},resolveEnabled(v){resolveEnabled=v},resolveStaleTime(v){resolveStaleTime=v},skipToken(v){skipToken=v},timeUntilStale(v){timeUntilStale=v}},1);let notifyManager;module.link("./notifyManager.js",{notifyManager(v){notifyManager=v}},2);let CancelledError,canFetch,createRetryer;module.link("./retryer.js",{CancelledError(v){CancelledError=v},canFetch(v){canFetch=v},createRetryer(v){createRetryer=v}},3);let Removable;module.link("./removable.js",{Removable(v){Removable=v}},4);
