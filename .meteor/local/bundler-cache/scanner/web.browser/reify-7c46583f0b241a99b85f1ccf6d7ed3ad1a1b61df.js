module.export({fromJSONSchema:()=>fromJSONSchema});let globalRegistry;module.link("../core/registries.js",{globalRegistry(v){globalRegistry=v}},0);let _checks;module.link("./checks.js",{"*"(v){_checks=v}},1);let _iso;module.link("./iso.js",{"*"(v){_iso=v}},2);let _schemas;module.link("./schemas.js",{"*"(v){_schemas=v}},3);
