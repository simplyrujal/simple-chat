module.export({streamedQuery:()=>streamedQuery});module.link("./chunk-PXG64RU4.js");let addConsumeAwareSignal,addToEnd;module.link("./utils.js",{addConsumeAwareSignal(v){addConsumeAwareSignal=v},addToEnd(v){addToEnd=v}},0);
