module.export({TimeoutManager:()=>TimeoutManager,defaultTimeoutProvider:()=>defaultTimeoutProvider,systemSetTimeoutZero:()=>systemSetTimeoutZero,timeoutManager:()=>timeoutManager});let __privateAdd,__privateGet,__privateSet;module.link("./chunk-PXG64RU4.js",{__privateAdd(v){__privateAdd=v},__privateGet(v){__privateGet=v},__privateSet(v){__privateSet=v}},0);
