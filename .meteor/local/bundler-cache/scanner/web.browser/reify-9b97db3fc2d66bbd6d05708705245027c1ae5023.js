module.export({default:()=>ScrollContainer});let jsx;module.link('react/jsx-runtime',{jsx(v){jsx=v}},0);let debounce;module.link('debounce',{default(v){debounce=v}},1);let React,PureComponent;module.link('react',{default(v){React=v},PureComponent(v){PureComponent=v}},2);let twMerge;module.link('./tailwind-merge.js',{twMerge(v){twMerge=v}},3);
