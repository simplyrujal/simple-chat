module.export({QueryClient:()=>QueryClient});let __privateAdd,__privateGet,__privateSet,__privateWrapper;module.link("./chunk-PXG64RU4.js",{__privateAdd(v){__privateAdd=v},__privateGet(v){__privateGet=v},__privateSet(v){__privateSet=v},__privateWrapper(v){__privateWrapper=v}},0);let functionalUpdate,hashKey,hashQueryKeyByOptions,noop,partialMatchKey,resolveStaleTime,skipToken;module.link("./utils.js",{functionalUpdate(v){functionalUpdate=v},hashKey(v){hashKey=v},hashQueryKeyByOptions(v){hashQueryKeyByOptions=v},noop(v){noop=v},partialMatchKey(v){partialMatchKey=v},resolveStaleTime(v){resolveStaleTime=v},skipToken(v){skipToken=v}},1);let QueryCache;module.link("./queryCache.js",{QueryCache(v){QueryCache=v}},2);let MutationCache;module.link("./mutationCache.js",{MutationCache(v){MutationCache=v}},3);let focusManager;module.link("./focusManager.js",{focusManager(v){focusManager=v}},4);let onlineManager;module.link("./onlineManager.js",{onlineManager(v){onlineManager=v}},5);let notifyManager;module.link("./notifyManager.js",{notifyManager(v){notifyManager=v}},6);let infiniteQueryBehavior;module.link("./infiniteQueryBehavior.js",{infiniteQueryBehavior(v){infiniteQueryBehavior=v}},7);
