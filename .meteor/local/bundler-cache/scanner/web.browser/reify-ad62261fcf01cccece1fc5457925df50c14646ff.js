module.export({Composite:()=>Composite,CompositeItem:()=>CompositeItem,FloatingArrow:()=>FloatingArrow,FloatingDelayGroup:()=>FloatingDelayGroup,FloatingFocusManager:()=>FloatingFocusManager,FloatingList:()=>FloatingList,FloatingNode:()=>FloatingNode,FloatingOverlay:()=>FloatingOverlay,FloatingPortal:()=>FloatingPortal,FloatingTree:()=>FloatingTree,NextFloatingDelayGroup:()=>NextFloatingDelayGroup,inner:()=>inner,safePolygon:()=>safePolygon,useClick:()=>useClick,useClientPoint:()=>useClientPoint,useDelayGroup:()=>useDelayGroup,useDelayGroupContext:()=>useDelayGroupContext,useDismiss:()=>useDismiss,useFloating:()=>useFloating,useFloatingNodeId:()=>useFloatingNodeId,useFloatingParentNodeId:()=>useFloatingParentNodeId,useFloatingPortalNode:()=>useFloatingPortalNode,useFloatingRootContext:()=>useFloatingRootContext,useFloatingTree:()=>useFloatingTree,useFocus:()=>useFocus,useHover:()=>useHover,useId:()=>useId,useInnerOffset:()=>useInnerOffset,useInteractions:()=>useInteractions,useListItem:()=>useListItem,useListNavigation:()=>useListNavigation,useMergeRefs:()=>useMergeRefs,useNextDelayGroup:()=>useNextDelayGroup,useRole:()=>useRole,useTransitionStatus:()=>useTransitionStatus,useTransitionStyles:()=>useTransitionStyles,useTypeahead:()=>useTypeahead});let React;module.link('react',{"*"(v){React=v}},0);let useModernLayoutEffect,useEffectEvent,getMinListIndex,getMaxListIndex,createGridCellMap,isListIndexDisabled,getGridNavigatedIndex,getGridCellIndexOfCorner,getGridCellIndices,findNonDisabledListIndex,isIndexOutOfListBounds,useLatestRef,getDocument$1,isMouseLikePointerType,contains$1,isSafari,enableFocusInside,isOutsideEvent,getPreviousTabbable,getNextTabbable,disableFocusInside,isTypeableCombobox,getFloatingFocusElement,getTabbableOptions,getNodeAncestors,activeElement,getNodeChildren$1,stopEvent,getTarget$1,isVirtualClick,isVirtualPointerEvent,getPlatform,isTypeableElement,isReactEvent,isRootElement,isEventTargetWithin,matchesFocusVisible,isMac,getDeepestNode,getUserAgent;module.link('@floating-ui/react/utils',{useModernLayoutEffect(v){useModernLayoutEffect=v},useEffectEvent(v){useEffectEvent=v},getMinListIndex(v){getMinListIndex=v},getMaxListIndex(v){getMaxListIndex=v},createGridCellMap(v){createGridCellMap=v},isListIndexDisabled(v){isListIndexDisabled=v},getGridNavigatedIndex(v){getGridNavigatedIndex=v},getGridCellIndexOfCorner(v){getGridCellIndexOfCorner=v},getGridCellIndices(v){getGridCellIndices=v},findNonDisabledListIndex(v){findNonDisabledListIndex=v},isIndexOutOfListBounds(v){isIndexOutOfListBounds=v},useLatestRef(v){useLatestRef=v},getDocument(v){getDocument$1=v},isMouseLikePointerType(v){isMouseLikePointerType=v},contains(v){contains$1=v},isSafari(v){isSafari=v},enableFocusInside(v){enableFocusInside=v},isOutsideEvent(v){isOutsideEvent=v},getPreviousTabbable(v){getPreviousTabbable=v},getNextTabbable(v){getNextTabbable=v},disableFocusInside(v){disableFocusInside=v},isTypeableCombobox(v){isTypeableCombobox=v},getFloatingFocusElement(v){getFloatingFocusElement=v},getTabbableOptions(v){getTabbableOptions=v},getNodeAncestors(v){getNodeAncestors=v},activeElement(v){activeElement=v},getNodeChildren(v){getNodeChildren$1=v},stopEvent(v){stopEvent=v},getTarget(v){getTarget$1=v},isVirtualClick(v){isVirtualClick=v},isVirtualPointerEvent(v){isVirtualPointerEvent=v},getPlatform(v){getPlatform=v},isTypeableElement(v){isTypeableElement=v},isReactEvent(v){isReactEvent=v},isRootElement(v){isRootElement=v},isEventTargetWithin(v){isEventTargetWithin=v},matchesFocusVisible(v){matchesFocusVisible=v},isMac(v){isMac=v},getDeepestNode(v){getDeepestNode=v},getUserAgent(v){getUserAgent=v}},1);let jsx,jsxs,Fragment;module.link('react/jsx-runtime',{jsx(v){jsx=v},jsxs(v){jsxs=v},Fragment(v){Fragment=v}},2);let getComputedStyle,isElement,isShadowRoot,getNodeName,isNode,isHTMLElement,getWindow,isLastTraversableNode,getParentNode,isWebKit;module.link('@floating-ui/utils/dom',{getComputedStyle(v){getComputedStyle=v},isElement(v){isElement=v},isShadowRoot(v){isShadowRoot=v},getNodeName(v){getNodeName=v},isNode(v){isNode=v},isHTMLElement(v){isHTMLElement=v},getWindow(v){getWindow=v},isLastTraversableNode(v){isLastTraversableNode=v},getParentNode(v){getParentNode=v},isWebKit(v){isWebKit=v}},3);let tabbable,isTabbable,focusable;module.link('tabbable',{tabbable(v){tabbable=v},isTabbable(v){isTabbable=v},focusable(v){focusable=v}},4);let ReactDOM;module.link('react-dom',{"*"(v){ReactDOM=v}},5);let getOverflowAncestors,useFloating$1,offset;module.link('@floating-ui/react-dom',{getOverflowAncestors(v){getOverflowAncestors=v},useFloating(v){useFloating$1=v},offset(v){offset=v}},6);module.link('@floating-ui/react-dom',{arrow:"arrow",autoPlacement:"autoPlacement",autoUpdate:"autoUpdate",computePosition:"computePosition",detectOverflow:"detectOverflow",flip:"flip",getOverflowAncestors:"getOverflowAncestors",hide:"hide",inline:"inline",limitShift:"limitShift",offset:"offset",platform:"platform",shift:"shift",size:"size"},7);let evaluate,max,round,min;module.link('@floating-ui/utils',{evaluate(v){evaluate=v},max(v){max=v},round(v){round=v},min(v){min=v}},8);
