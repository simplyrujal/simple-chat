module.export({MutationObserver:()=>MutationObserver});let __privateAdd,__privateGet,__privateMethod,__privateSet;module.link("./chunk-PXG64RU4.js",{__privateAdd(v){__privateAdd=v},__privateGet(v){__privateGet=v},__privateMethod(v){__privateMethod=v},__privateSet(v){__privateSet=v}},0);let getDefaultState;module.link("./mutation.js",{getDefaultState(v){getDefaultState=v}},1);let notifyManager;module.link("./notifyManager.js",{notifyManager(v){notifyManager=v}},2);let Subscribable;module.link("./subscribable.js",{Subscribable(v){Subscribable=v}},3);let hashKey,shallowEqualObjects;module.link("./utils.js",{hashKey(v){hashKey=v},shallowEqualObjects(v){shallowEqualObjects=v}},4);
